...
if [ $1 == 'before' ]; then
	...
	# curl -L https://github.com/woocommerce/woocommerce.git | tar -zx -C "woocommerce"
	curl -L https://api.github.com/repos/woocommerce/woocommerce/tarball | tar -zx -C "woocommerce"
